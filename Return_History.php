...
<html>
    <body>
        ...
        <div class="pickup-history">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "_POST" && isset($_POST['return_search'])) {
                ...
                $pickup_history = $_POST['return_history'];
                $sql = "SELECT * FROM pickup_history, dropoff history WHERE item_number LIKE '%$return_search%'";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '<div id="pick-up" class="w3-container menu w3-padding-48 w3-card">';
                        echo '<p><b>Customer Address</b></p>';
